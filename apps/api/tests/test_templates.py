...
def test_every_template_analyzes_clean(template_id):
    # The whole D17 promise: every flow we ship arrives with zero findings.
    # Parametrizing over the registry means a new template gets this test for free.
