...
def safe_marketplace() -> Workflow:
    ...
    nodes = [
        ...
        _n("balance", "safety.balance_guard", "Check Balance First", 720, 340),
        _n("transfer", "monnify.initiate_transfer", "Transfer to Provider (minus 5%)", 960, 340),
        _n("qstatus", "monnify.query_transfer_status", "Query Transfer Status", 1200, 340),
        _n("audit", "safety.audit_event", "Audit", 1440, 340),
